...
This folder defines all source code for the test2_pipeline pipeline:
...
* Take a look at the sample under "sample_trips_test2.py" to get familiar with the syntax.
